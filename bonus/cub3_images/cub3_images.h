...
/*   Updated: 2025/11/29 22:02:35 by yusudemi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			draw_image_scaled(t_window *win, t_cub3_image *img,
					t_pos pos, double scale);
void			draw_image_no_alpha(t_window *win, t_cub3_image *img,
					int x, int y);
void			draw_image_no_alpha_scaled(t_window *win, t_cub3_image *img,
					t_pos pos, double scale);
void			draw_button(t_window *win, t_cub3_image *img, int x, int y);
void			draw_button_hover(t_window *win, t_cub3_image *img,
					int x, int y);
void			draw_column(t_draw_pkg *pkg, int x, t_window *win);
int				blend_alpha(int color, int color_to_blend, double alpha);
void			draw_column_alpha(t_draw_pkg *pkg,
					int x, int blend, double alpha);
